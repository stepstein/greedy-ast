...
Kurze Erklärung + copy-&-paste Befehlmarkdown<br>bash# ohne Parameter: zählt bis 1e8docker run –rm ghcr.io/stepstein/greedy-ast:latest# mit eigenem Limitdocker run –rm ghcr.io/stepstein/greedy-ast:latest \\n    python benchmarks.py 1000000000```
